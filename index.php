...
<section class="bg-teal-950">
      ...
      <nav class="flex flex-col md:flex-row justify-between shadow-sm shadow-amber-500 items-center lg:px-20 md:px-10 px-5 py-4"> 
          <div class="flex justify-between items-center w-full md:w-auto">
              <img src="images/logo.png" alt="Light House Hotel Logo" class="w-20">
    ...
    <div class="flex gap-10 flex-col justify-center items-center md:flex-row lg:items-center lg:justify-between">
        <div class="md:w-[45%] w-full lg:py-10 md:py-5 text-center lg:text-left" data-aos="fade-down">
            <h1 class="text-7xl text-white font-medium ">Light House Hotel</h1>
          <p class="text-amber-500 text-xl my-5 heading">
Welcome to Light House Hotel. We provide luxury rooms,
excellent services, and a relaxing environment for our guests.
Enjoy comfort, security, and the best hospitality experience.
</p>
            <div class="my-5">
    ...
    <div class="lg:px-20 md:px-10 px-4">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="w-full md:w-1/2 text-center md:text-left">
                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3">Subscribe to Light House Newsletter</h2>
                <p class="text-amber-500 text-sm sm:text-base">Get special offers, hotel updates, and travel tips from Light House Hotel.</p>
            </div>
    ...
    <div class="lg:px-20 md:px-10 px-4 py-8 sm:py-12 lg:py-16">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="text-center sm:text-left">
                <img src="images/logo.png" alt="Light House Hotel Logo" class="w-16 sm:w-20 mb-4 mx-auto sm:mx-0">
<p class="text-gray-600 mb-4 text-sm sm:text-base">
Light House Hotel offers comfortable rooms, quality services,
and a peaceful environment for all our guests.
</p>
            ...
            <div class="text-center sm:text-left">
                ...
                <ul class="space-y-3">
                    <li class="flex items-center text-gray-600 justify-center sm:justify-start">
                        ...
                        <span class="text-sm sm:text-base">Light House Hotel, Huye, Rwanda</span>
                    </li>
                    <li class="flex items-center text-gray-600 justify-center sm:justify-start">
                        <i class="fas fa-phone w-5"></i>
                        <span class="text-sm sm:text-base">+250 792 378 640</span>
                    </li>
                    <li class="flex items-center text-gray-600 justify-center sm:justify-start">
                        <i class="fas fa-envelope w-5"></i>
                        <span class="text-sm sm:text-base">info@lighthousehotel.com</span>
                    </li>
                </ul>
            </div>
    ...
    <div class="bg-teal-950 py-4">
        <div class="lg:px-20 md:px-10 px-4">
            <div class="flex flex-col sm:flex-row justify-between items-center text-white gap-3">
                <p class="text-sm sm:text-base text-center sm:text-left">&copy; 2026 Light House Hotel. All rights reserved.</p>
