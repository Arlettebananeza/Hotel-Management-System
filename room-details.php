...
<section class="bg-teal-950">
    ...
    <section class="bg-teal-950 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl mb-8 max-w-3xl mx-auto">Experience luxury, comfort, and exceptional service at lighthouse Hotel. Book your room today and create unforgettable memories.</p>
